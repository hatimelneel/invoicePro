...
async function openNativePDF(){
  if(!previewDoc){alert(tr("Nothing to export.","لا توجد فاتورة للتصدير."));return;}
  // Open a blank tab immediately to satisfy iOS popup rules.
  const pdfWindow=window.open("","_blank");
  if(!pdfWindow){alert(tr("Please allow pop-ups or open the site in Safari.","يرجى السماح بالنوافذ المنبثقة أو فتح الموقع في Safari."));return;}
