...
function importBackupFile(event){
  ...
  // A real backup containing actual app data is normally much larger.
  // Very tiny files are usually failed iOS/Files exports or placeholders.
  ...
  reader.onload=()=>{
    try{
      ...
      const incoming=migrateBackupData(rawIncoming);
      const summary=backupContentsSummary(incoming);
      ...
      alert(tr(
        "Backup restored successfully. "+details+" restored.",
        "تمت استعادة النسخة الاحتياطية بنجاح. تم استرجاع "+details+"."
      ));
      ...
      let message=tr(
        "This file could not be restored. It may be incomplete or not an Invoice Pro JSON backup.",
        "تعذر استعادة هذا الملف. قد يكون غير مكتمل أو ليس نسخة JSON صحيحة من Invoice Pro."
      );
